...
* [`optimize.cpp`](/optimize.cpp): Exporta la función que halla k* en las simulaciones ejecutadas en [`simulate_from_influence_model.R`](/simulate_from_influence_model.R). Este archivo no tiene dependencias ni debe ser ejecutado manualmente.
